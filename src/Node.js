class Node {
    ...
    static EDGECOLOR = color('#4f4e4e');   
    static EDGETHICKNESS = 4;            

    
    static VISITED = color('#39a5e3');  
    static SUCCESS = color('#7cf283');      
                                        
    static FAILURE = color('#eb3d49');  
                                        

    static HORIZONTALSPACING = 45; 
